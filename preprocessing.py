...
train_data_dir = Path('/content/drive/DoAnTHDL/dataset/train')
test_data_dir = Path('/content/drive/DoAnTHDL/dataset/test')
val_data_dir = Path('/content/drive/DoAnTHDL/dataset/val') 
